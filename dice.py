...
_OUTCOME_GM_HINTS = {
    "天命": "命運走向極度正面——超乎預期的機緣降臨。但好運未必沒有隱患，功高震主、樹大招風、樂極生悲皆有可能。",
    "順遂": "命運走向偏正面——事態發展有利。但順境中可能暗藏伏筆，過於順利意味著某處正在積累風險。",
    "平淡": "命運走向中性——不偏不倚，一切按常理發展。結果完全取決於角色自身的能力、準備和選擇。",
    "波折": "命運走向偏負面——遇到阻礙或意外轉折。但塞翁失馬焉知非福，挫折可能帶來意外的發現、盟友、或成長契機。",
    "劫數": "命運走向極度負面——重大考驗降臨，處境艱難。但危機往往是轉機的起點，絕境中的突破、因禍得福、置之死地而後生。",
}

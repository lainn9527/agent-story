...
from story_core.compaction import get_recap_text, load_recap, should_compact, compact_async
from story_core.llm_bridge import call_claude_gm, call_oneshot, set_provider, web_search
from story_core.world_timer import set_world_day
from story_core import usage_db
from story_core.npc_evolution import should_run_evolution, run_npc_evolution_async
from story_core.auto_summary import should_generate_summary, generate_summary_async, _load_summaries
...
def generate_random_character(story_id: str) -> dict:
    ...
    usage_db.log_from_bridge(story_id, "auto_play_chargen", time.time() - t0_char)
...
def generate_player_action(
    ...
    usage_db.log_from_bridge(story_id, "auto_play_player", _player_elapsed, branch_id=branch_id)
    if not response:
